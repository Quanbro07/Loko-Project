...
class FoodSolver(BaseSolver):
    ...
    def format_solution(self, solution):
        visited_nodes = []
        trip_details = [] # List các object tripDetail mới
        ...
        while not self.routing.IsEnd(index):
            ...
            trip_details.append({
                ...
                "startTime": start_str,
                "endTime": end_str,
                "description": name, # Dùng tên làm mô tả ngắn gọn
                "tags": tags,
                "image": image_url
            })
            sequence_order += 1
