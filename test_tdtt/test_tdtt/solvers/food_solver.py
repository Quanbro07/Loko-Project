...
class FoodSolver(BaseSolver):
    ...
    def format_solution(self, solution):
        ...
        entry = {
            "start": end_str_final,
            "end": end_str_final,
            "place_id": depot_place.get("place_id"),
            "title": f"Quay về {depot_place.get('title', 'Khách sạn')}",
            "description": depot_place.get("description"),
            "rating": depot_place.get("rating"),
            "longitude": depot_place.get("longitude"),
            "latitude": depot_place.get("latitude")
        }
        schedule_data.append(entry)
